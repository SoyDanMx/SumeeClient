                                ...
                                <Card variant="elevated" style={[styles.sectionCard, { backgroundColor: theme.surface }]}>
                                    <View style={styles.toggleRow}>
                                        ...
                                        <Switch
                                            ...
                                            trackColor={{ false: theme.border, true: TULBOX_COLORS.PURPLE + '80' }}
                                            thumbColor={settings.push_enabled ? TULBOX_COLORS.PURPLE : '#f4f3f4'}
                                        />
                                    </View>
                                </Card>
                                        ...
                                        <View style={styles.section}>
                                            ...
                                            <Card variant="elevated" style={[styles.sectionCard, { backgroundColor: theme.surface }]}>
                                                ...
                                                <NotificationToggle
                                                    ...
                                                    description="Notificaciones importantes de TulBoxApp sobre tu cuenta y servicios"
                                            ...
                                            <Card variant="elevated" style={[styles.sectionCard, { backgroundColor: theme.surface }]}>
                                                <View style={styles.toggleRow}>
                                                    ...
                                                    <Switch
                                                        ...
                                                        trackColor={{ false: theme.border, true: TULBOX_COLORS.PURPLE + '80' }}
                                                        thumbColor={settings.quiet_hours_enabled ? TULBOX_COLORS.PURPLE : '#f4f3f4'}
                                                    />
                                                </View>
    ...
    return (
        <View style={styles.toggleRow}>
            ...
            <Switch
                ...
                trackColor={{ false: theme.border, true: TULBOX_COLORS.PURPLE + '80' }}
                thumbColor={value ? TULBOX_COLORS.PURPLE : '#f4f3f4'}
            />
        </View>
    );
}
