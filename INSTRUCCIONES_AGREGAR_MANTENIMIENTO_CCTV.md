# ✅ Instrucciones: Agregar Servicio CCTV - Mantenimiento a Sistema

**Fecha:** 2025-01-10  
**Servicio:** Mantenimiento a Sistema de CCTV con 4 canales (únicamente mano de obra)  
**Precio:** $1,500 MXN
...
- **Nombre:** Mantenimiento a Sistema de CCTV con 4 canales (únicamente mano de obra)
- **Disciplina:** `cctv`
- **Precio:** $1,500 MXN (fijo)
- **Tipo de precio:** `fixed`
- **Incluye materiales:** NO (únicamente mano de obra)
- **Estado:** Activo
- **Popular:** No (por defecto)
- **Descripción:** Mantenimiento profesional a sistema de CCTV con 4 canales. Incluye limpieza de cámaras, verificación de conexiones, actualización de firmware, revisión de grabaciones y ajustes de configuración. Únicamente mano de obra, sin materiales.
...
2. Ve a **SQL Editor**
3. Copia y pega el contenido de `AGREGAR_SERVICIO_CCTV_MANTENIMIENTO.sql`
4. Ejecuta el script
5. Verifica que aparezca uno de estos mensajes:
   - `✅ Servicio CCTV "Mantenimiento a Sistema de CCTV con 4 canales" creado exitosamente` (si no existía)
   - `✅ Servicio CCTV "Mantenimiento a Sistema de CCTV con 4 canales" actualizado al nombre estándar` (si existía con otro nombre)
...
**Resultado esperado:**
- ✅ 4 servicios de CCTV (ordenados por precio):
  ...
  3. Mantenimiento a Sistema de CCTV con 4 canales (únicamente mano de obra) - $1,500
  4. Instalación de Kit de 4 Cámaras de CCTV (únicamente mano de obra, sin materiales) - $2,000
...
- Deberías ver **4 servicios** (ordenados por precio)
...
3. **Verificar logs en consola:**
   ...
   - Verificar que la query trae 4 servicios
...
- **Sin Materiales:** `includes_materials = false` porque es únicamente mano de obra (no incluye repuestos ni materiales)
- **Precio Fijo:** `price_type = 'fixed'` en $1,500 MXN garantiza consistencia
