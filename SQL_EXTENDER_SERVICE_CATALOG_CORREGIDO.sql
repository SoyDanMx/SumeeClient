-- =========================================================================
-- EXTENSIÓN DE service_catalog PARA VANGUARDIA TECNOLÓGICA (CORREGIDO)
-- =========================================================================
-- Fecha: 2025-01-XX
-- Objetivo: Agregar campos necesarios para alineación con web y app cliente
-- CORRECCIÓN: Error de sintaxis en línea 67-69 (precedencia de operadores)
-- =========================================================================
...
-- CORRECCIÓN: Agregados paréntesis para precedencia correcta
UPDATE public.service_catalog
SET 
    is_popular = true,
    service_type = 'pro',
