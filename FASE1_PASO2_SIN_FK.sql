-- ============================================================================
-- FASE 1.2: CREAR TABLAS - SIN FOREIGN KEY (PARA EVITAR ERRORES)
-- ============================================================================
-- Versión que crea las tablas SIN foreign keys primero
-- Luego agregamos las foreign keys por separado
-- ============================================================================

-- ============================================================================
-- 2.1: Tabla service_embeddings (SIN FK PRIMERO)
-- ============================================================================

CREATE TABLE IF NOT EXISTS public.service_embeddings (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    service_id UUID NOT NULL,  -- ✅ Sin FK por ahora
    service_name TEXT NOT NULL,
    discipline TEXT NOT NULL,  -- ✅ COLUMNA PROPIA, independiente
...
CREATE TABLE IF NOT EXISTS public.user_features (
    user_id UUID PRIMARY KEY,  -- ✅ Sin FK por ahora
    embedding vector(384),
...
CREATE TABLE IF NOT EXISTS public.ml_interactions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID,  -- ✅ Sin FK por ahora
    query TEXT NOT NULL,
    query_embedding vector(384),
    predicted_service_id UUID,  -- ✅ Sin FK por ahora
    predicted_service_name TEXT,
    predicted_confidence NUMERIC(3, 2),
    actual_service_id UUID,  -- ✅ Sin FK por ahora
    actual_service_name TEXT,
    conversion BOOLEAN DEFAULT false,
    lead_id UUID,  -- ✅ Sin FK por ahora
    features JSONB,
...
CREATE TABLE IF NOT EXISTS public.ml_feedback (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    interaction_id UUID,  -- ✅ Sin FK por ahora
    user_id UUID,  -- ✅ Sin FK por ahora
    was_correct BOOLEAN NOT NULL,
    feedback_text TEXT,
    rating INTEGER CHECK (rating >= 1 AND rating <= 5),
    correct_service_id UUID,  -- ✅ Sin FK por ahora
...
SELECT 
    'Tablas creadas (sin FK):' as status,
    COUNT(*) as total
